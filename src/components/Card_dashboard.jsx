...
const Card = () => {
    return(
       <div className="bg-white h-40 w-full mt-2 border-2 border-stone-100 rounded-xl flex" >
            ...
            <div className="bg-stone-100 grow max-w-60 h-full p-2 rounded-lg relative">
